...
The ASCII code equivalent, in hexadecimal form, for the characters in the string are: `\t (TAB)` = `0x9h`, `p` = `0x70h`, `k` = `0x6Bh`, `d` = `0x64h`.

## Algorithms of Other (Non-Standard) Functions

### sub_401080

![Figure 2 Flowchart showing algorithm of sub_401080](flowchart-sub-401080.png "Figure 2 Flowchart showing algorithm of sub_401080")
